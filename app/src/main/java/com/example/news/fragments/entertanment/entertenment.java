package com.example.news.fragments.entertanment;
 ...
 * Use the {@link entertenment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class entertenment extends Fragment {
     ...
     * @return A new instance of fragment entertenment.
     */
    // TODO: Rename and change types and number of parameters
    public static entertenment newInstance(String param1, String param2) {
        entertenment fragment = new entertenment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_entertenment, container, false);
        get_data();
        recyvler_intial(v);
        return v;
    }
    ...
    {
        entertainment=v.findViewById(R.id.entertenment_recyclerview);
    ...
    public void get_data()
    {
        ...
        Call<main_class> call=api.calldata_category("eg","entertainment",api_code);
