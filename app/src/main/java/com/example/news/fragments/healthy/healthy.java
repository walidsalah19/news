package com.example.news.fragments.healthy;
 ...
 * Use the {@link healthy#newInstance} factory method to
...
public class healthy extends Fragment {
     ...
     * @return A new instance of fragment healthy.
     */
    // TODO: Rename and change types and number of parameters
    public static healthy newInstance(String param1, String param2) {
        healthy fragment = new healthy();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_healthy, container, false);
        get_data();
        recyvler_intial(v);
        return v;
    }
    ...
    {
        entertainment=v.findViewById(R.id.healthy_recyclerview);
