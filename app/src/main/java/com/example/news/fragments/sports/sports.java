package com.example.news.fragments.sports;
...
public class sports extends Fragment {
    ...
    {
        entertainment=v.findViewById(R.id.sports_recyclerview);
    ...
    public void get_data()
    {
        ...
        Call<main_class> call=api.calldata_category("eg","sports",api_code);
