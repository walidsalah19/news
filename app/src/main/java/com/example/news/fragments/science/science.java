package com.example.news.fragments.science;
...
public class science extends Fragment {
    ...
    {
        entertainment=v.findViewById(R.id.science_recyclerview);
    ...
    public void get_data()
    {
        ...
        Call<main_class> call=api.calldata_category("eg","science",api_code);
